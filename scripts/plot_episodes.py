...
def plot_rel_use():
    plot_relative_usage('/home/marcrigter/pCloudDrive/Development/LearnToManipulate/data/main_experiment/human_learner_mab/alpha_2_0', 1200)
...
def plot_human_cost():
    folders =  ['/home/marcrigter/pCloudDrive/Development/LearnToManipulate/data/main_experiment/human_learner_mab/alpha_1_0',
                ...
                '/home/marcrigter/pCloudDrive/Development/LearnToManipulate/data/main_experiment/human_then_learner/100demos']

    methods = ['alpha = 1', 'alpha = 2', '100 demos']
    plot_human_cost_sliding_window(folders, methods, num_episodes = 1100, cost_failure = 5.0)
