...
if __name__ == "__main__" :
    ...
    for i in range(0, 5):
        ...
        for case_number in range(0, 1005):
            if case_number < 170:
            ...
            if (case_number - 1) % 100 == 0:
                sim.save_simulation('/home/marcrigter/pCloudDrive/Development/LearnToManipulate/data/initial_tests/tuning_problem_domain/final_cases/demos_then_rl')
